...
sys.path.append('/home/sannavarapu/rosetta/rosetta_tools/protein_tools/scripts')
...
local_pdb_database = "~/scaffolds/"
keep_ligand = False    # set to false to throw away all HETATMs, not just the confusing non-canonical Amino Acids
###############################################################################################
...
##                    resnum = line_edit[23:26]
            ...
            if removechain:
                line_edit = line_edit[0:21]+'A'+line_edit[22:]
